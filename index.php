...
<head>
  ...
  <!-- icono empresa -->
  <link rel="shortcut icon" href="logo/logo_webtech.png" />
</head>
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <img src="logo/logo.png" width="300px" alt=" Logo de la Empresa">
    ...
    <div class="card-body">
      <!-- <p class="login-box-msg">Iniciar Sesion</p>-->
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Ingrese su Usuario" id="text_usuario">
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" placeholder="Ingrese su Clave" id="text_clave">
          <div class="input-group-append">
            <div class="input-group-text">
      ...
      <div class="text-center" style="font-size: 12px; color: dark; font-weight: bold;">© Mexico - Inventario<br/>Todos los derechos	reservados</div>
     <!-- <p class="mb-0">
