 ...
 ********************************************************************/
                                    ...
                                    $.ajax({
                                        ...
                                        if (data.length>0) {
                                                ...
                                                Swal.fire({
                                                    ...
                                                    html: 'Seras redireccionado en <b></b> breve.',
                                                    timer: 2000,
                                ...
                                function Registrar_Permisos(id){
                                    ...
                                    $("#permisos[] li ").each(function(){
                                        permisos.push($(this).find('li').eq(0).text());
                                
                                        count++;
                                    })
                                
                                    let permisosVal  = permisos.toString();
                                
                                
                                        $.ajax({
                                         url:'../controller/usuario/controlador_registrar_permisos.php',
                                         type: 'POST',
                                         data:{
                                             id:id,
                                             permisos:permisos
